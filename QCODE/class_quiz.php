								...
								<form action="delete_class_quiz.php<?php echo '?id='.$get_id; ?>" method="post">
									...
									<?php include('modal_delete_class_quiz.php'); ?>
										<thead>
												...
												<th>Quiz Type</th>
												<th>Submissions</th> <!-- New column header for student submissions -->
												</tr>
										</thead>
										<tbody>
										<?php
										...
										while ($row = mysqli_fetch_array($query)) {
											...
											// Retrieve student submissions count for the current quiz
											$submission_query = mysqli_query($conn, "SELECT * FROM student_class_quiz WHERE class_quiz_id = '$id'") or die(mysqli_error());
											$submission_count = mysqli_num_rows($submission_query);
										?>
											<tr id="del<?php echo $id; ?>">
												...
												<td><?php echo $submission_count; ?></td> <!-- Display the number of submissions -->
											</tr>
										<?php } ?>
										</tbody>
									</table>
