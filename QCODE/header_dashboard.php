...
<html class="no-js">
    <head>
        <title>QUEST - ATLANTIC</title>
		<meta name="description" content="Q - Atlantic Learning Management System">
		<meta name="keywords" content="CHMSC LMS,CHMSCLMS,CHMSC,LMS,CHMSCLMS.COMXA">
		<meta name="author" content="QC - INTERNS">
		<meta charset="UTF-8">
        <link rel="icon" type="image/x-icon" href="admin/images/favicon.png">
        <!-- Bootstrap -->
